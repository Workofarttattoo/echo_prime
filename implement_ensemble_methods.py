...
async def implement_ensemble_methods():
    ...
    for i, test_case in enumerate(test_questions, 1):
        ...
        try:
            ...
            print(f"    ✅ Result: confidence {result.confidence_score:.2f}, consensus {result.consensus_level:.2f}")
    ...
    for example in focus_examples[:3]:
        ...
        print(f"    • Priority {analysis['learning_priority']:.2f}: {example['question'][:40]}...")
